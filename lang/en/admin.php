...
$string['recentauthadmin'] = 'Require recent authentication for secure pages';
$string['recentauthadmin_desc'] = 'Require recent authentication for any pages that require administrator rights to access. A user must authenticate themselves to access the page. If it has been greater than a specified time since last authentication, users will be prompted to re-authenticate';
$string['recentauthtime'] = 'Time period for recent authentication';
$string['recentauthtime_desc'] = 'When accessing high security pages, administrators must have performed authentication within this period. If no authentication has been performed within this period, users will be prompted to re-authenticate.';
