...
class core_grades_external extends external_api {
     ...
     */
    private static function create_gradecategories_from_data(int $courseid, array $categories) {
        global $CFG, $DB;
    ...
    public static function create_gradecategory(int $courseid, string $fullname, array $options) {
        ...
        $result = self::create_gradecategories_from_data($courseid, $categories);
