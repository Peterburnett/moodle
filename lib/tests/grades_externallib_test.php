...
class core_grades_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_create_gradecategories() {
        ...
        $status1 = core_grades_external::create_gradecategories($course->id, [['fullname' => 'Test Category 1', 'options' => []]]);
        ...
        $status2 = core_grades_external::create_gradecategories($course->id,
        ...
        $status3 = core_grades_external::create_gradecategories($course->id,
        ...
        $status4 = core_grades_external::create_gradecategories($course->id, [
            [
