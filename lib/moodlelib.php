...
function email_to_user($user, $from, $subject, $messagetext, $messagehtml = '', $attachment = '', $attachname = '',
    ...
    // Get mailer class.
    $factory = \core\email\factory::get_factory();
    $manager = $factory->get_mail_manager();

    // Setup the mail parameters.
    $manager->init($user, $from, $subject, $messagetext, $messagehtml, $attachment, $attachname,
        $usetrueaddress, $replyto, $replytoname, $wordwrapwidth);

    // Send the mail.
    return $manager->mail_to_user();
}
