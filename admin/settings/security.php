...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configcheckbox('recentauthadmin', new lang_string('recentauthadmin', 'admin'),
        new lang_string('recentauthadmin_desc', 'admin'), 0));

    $temp->add(new admin_setting_configduration('recentauthtime',
        new lang_string('recentauthtime', 'admin'),
        new lang_string('recentauthtime_desc', 'admin'), 15 * MINSECS, MINSECS));
